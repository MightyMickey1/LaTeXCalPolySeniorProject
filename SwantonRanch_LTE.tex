...
temporary, removable installation; a project budget of approximately \$5,000 for
...
The total street value of the hardware used in this project is estimated at
...
To regenerate the cleaned data: \texttt{cd} to \texttt{Test Phone Data/} and
run \texttt{python3 clean\_drive\_test\_data.py}.
